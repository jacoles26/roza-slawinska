...
export default function About() {
  ...
  return (
    <PageTransition>
      <Seo title={content.seo.about.title} description={content.seo.about.description} />
      ...
      <section className="container-editorial grid items-start gap-10 pb-24 md:grid-cols-[1.1fr_1fr] md:gap-20">
        <Reveal className="relative aspect-[4/5] overflow-hidden rounded-squircle bg-paper-deep">
          <Picture slug="editorial-garden" alt={content.name} className="h-full w-full" loading="eager" />
        </Reveal>
      ...
      <section className="container-editorial py-24 md:py-32">
        <Reveal>
          <h2 className="display-md max-w-2xl text-ink">{about.valuesTitle}</h2>
        </Reveal>
      ...
      <section className="container-editorial pb-24 md:pb-32">
        <div className="grid gap-10 md:grid-cols-[1fr_1.2fr] md:gap-20">
          <Reveal>
            <h2 className="display-md text-ink">{about.detailsTitle}</h2>
            <p className="mt-5 max-w-sm text-ink-soft">{about.detailsIntro}</p>
            <Link to={localePath("/contact")} className="mt-8 btn-island">
              {about.detailsButton}
