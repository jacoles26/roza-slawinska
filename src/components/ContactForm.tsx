...
export default function ContactForm() {
  ...
  return (
    ...
    >
      ...
      <Field label="Subject" name="subject" type="text" placeholder="Booking · Collaboration · Press" />
      ...
      <div className="flex items-center gap-4">
        ...
        {status === "error" && (
          <span className="text-sm text-clay">Something went wrong — please try again.</span>
        )}
      </div>
    </form>
  );
